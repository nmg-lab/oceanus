...
//  });
	...
	var defaultDateData ={};
	defaultDateData.day = defaultDate.getDate();
	defaultDateData.year = defaultDate.getFullYear();
	defaultDateData.mounth = defaultDate.getMonth();
    calender('#calend1').init({format : 'yyyy-MM-dd',
    date : [defaultDateData.year,defaultDateData.mounth,defaultDateData.day],
        button : true
    },function(date){
        this.value = date
    });
